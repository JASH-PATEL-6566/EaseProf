...
export default function MarkdownHeader() {
    return (
        <em>
            ...
            {data.port.value && data.port.link ? <p>*    {data.port.sub_start}{data.port.prev}{data.port.tag_start}{`<a herf="${data.port.link}" target='_blank'>`}{data.port.value}{`</a>`}{data.port.tag_end}{data.port.sub_end}</p> : ''}
            {data.contact.value && <p>*    {data.contact.sub_start}{data.contact.prev}{data.contact.tag_start}{`<a herf="mailto:${data.contact.value}" target='_blank'>`}{data.contact.value}{`</a>`}{data.contact.tag_end}{data.contact.sub_end}</p>}
            {data.current.value && data.current.link ? <p>*    {data.current.sub_start}{data.current.prev}{data.current.tag_start}{`<a herf="${data.current.link}" target='_blank'>`}{data.current.value}{`</a>`}{data.current.tag_end}{data.current.sub_end}</p> : ''}
