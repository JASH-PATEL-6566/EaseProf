    ...
    return (
        <>
            <div className='header'>
                ...
                {props.type === "textarea" && <textarea onChange={props.onEvent} putvalue={`${props.value}`} id="w3review" name="w3review" className='input' rows="4" cols="50" placeholder={props.placeholder}></textarea>}
            </div>
            {props.name === "aboutMe" &&
